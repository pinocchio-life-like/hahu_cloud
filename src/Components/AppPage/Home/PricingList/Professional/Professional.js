  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      <div
        ...
        <div style={{ fontWeight: 700, fontSize: 20 }}>🚗 Professional</div>
        <div>Best For Developers</div>
        <div>
          <span style={{ fontSize: 28, fontWeight: 700 }}>3,960 </span> Birr /
          year
        </div>
        <div style={{ fontWeight: 650 }}>330 Birr / Month</div>
      </div>
      <div
        style={{
          display: "flex",
        ...
        <div
          ...
          <CheckOutlined /> 80GB NVMe Storage
        </div>
        <div
          style={{
            color: "#42526e",
